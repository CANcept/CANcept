...
//      * @details Used to detect clicks on the central "Upload Box" frame to trigger the file
//      dialog.
//      */
...
//      * @caller Constructor.
//      * @details Creates the ScrollArea, File Info Group, Stat Cards Layout, and the Overview
//      Lists.
//      */
//     void setupUi();
//
...
//      * @caller Constructor.
//      * @details Instantiates the SearchableFilterTree and installs the EcuTreeDelegate on the
//      view.
//      */
//     void setupUi();
//

...
#include "manipulation_type_delegate.hpp"
...
ManipulationTypeDelegate::ManipulationTypeDelegate(QObject* parent) : QStyledItemDelegate(parent) {}

void ManipulationTypeDelegate::paint(QPainter* painter, const QStyleOptionViewItem& option,
...
QSize ManipulationTypeDelegate::sizeHint(const QStyleOptionViewItem& option,
                                         const QModelIndex& index) const
{
    Q_UNUSED(index)
    const auto& spacing = THEME.spacing();

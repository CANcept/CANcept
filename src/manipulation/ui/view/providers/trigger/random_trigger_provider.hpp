...
class RandomTriggerProvider final : public IManipulationRowTypeProvider
{
   public:
    ...
    [[nodiscard]] auto createOptionsWidget(QWidget* parent) const -> QWidget* override
    {
        ...
        auto* label = new QLabel("prob:", container);
        auto* spin = new QDoubleSpinBox(container);
        spin->setObjectName(Constants::PARAM_PROB_INPUT);

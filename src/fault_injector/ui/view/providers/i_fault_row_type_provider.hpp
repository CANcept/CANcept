...
/**
 * @class IFaultRowTypeProvider
 * @brief Interface for supplying a named type and its configuration widget to a FaultRowWidget.
 */
class IFaultRowTypeProvider
{
   public:
    virtual ~IFaultRowTypeProvider() = default;

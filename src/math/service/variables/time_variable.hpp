...
public:
    ...
    double* ptr() override { return &m_value; }
...
private:
    ...
    static double factorFor(const TimeUnit unit)
    {
        switch (unit)
        {
            case TimeUnit::Seconds:      return NANOS_TO_SECONDS;
            case TimeUnit::Milliseconds: return NANOS_TO_MILLIS;
            case TimeUnit::Nanoseconds:  return NANOS_TO_NANOS;
        }
